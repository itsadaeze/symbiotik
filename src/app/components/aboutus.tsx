...
const AboutUs = () => {
    return(
        <div className="bg-[#FFFFFF] px-[1rem] py-10 md:py-20 w-full md:px-[2rem] lg:px-8 ">
        <div className="max-w-[1400px] mx-auto flex flex-col  ">
         <div className="flex flex-col-reverse lg:flex-row justify-between gap-[20%] items-center lg:items-start">
         ...
         <div className=" flex flex-col md:flex-row mt-3 md:mt-10  px-1 items-center gap-[0%] md:gap-[10%]">
         <TitleDescription
        image={icons.about_icon}
        title="Renewable Energy"
        description="State-of-the-art solar solutions for sustainable power generation"
        titleClassName="text-[#0F7BFF] mt-3 md:mt-5"
        ...
        titleClassName="text-[#0F7BFF] mt-3 md:mt-5"
        descriptionClassName="text-gray-700 w-[90%]"
         className = 'mt-9 md:mt-0'
         />
