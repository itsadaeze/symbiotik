...
const testimonies = [
    { id: 1, imageSrc: '/assets/images/avartar.png', title: 'Chika O.', description:'“I needed a plumber urgently and found one in 5 minutes! So easy to use.”', icon:'/assets/icons/rating.svg' },
    { id: 2, imageSrc: '/assets/images/avartar.png', title: 'Ashley Cooper', description: 'I really like the system at this management, i love recommending this software to you guys', icon:'/assets/icons/rating.svg'},
    { id: 3, imageSrc: '/assets/images/avartar.png', title: 'Chika O.', description:'“I needed a plumber urgently and found one in 5 minutes! So easy to use.”', icon:'/assets/icons/rating.svg' },
    { id: 4, imageSrc: '/assets/images/avartar.png', title: 'Ashley Cooper', description: 'I really like the system at this management, i love recommending this software to you guys', icon:'/assets/icons/rating.svg' },
  ];
    ...
    return(
        <section className=" bg-[#0F7BFF] px-[1rem] py-10  w-full md:px-[2rem] lg:px-8 ">
            ...
            <div className='flex flex-col lg:flex-row items-center  '>
             ...
             <div ref={scrollRef} className="flex overflow-x-auto gap-7 mt-10 scrollbar-hide w-[90%]">
